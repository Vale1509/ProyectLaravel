    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('p.create') }}" method="post">
                    @csrf
                    <div class="mb-3">
                ...
                @foreach ($perros as $item)
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="{{route('p.delete',$item->id)}}" onclick="return res()" class="btn btn-danger btn-sm"> <i class="fa-solid fa-trash"></i></a>
                        </td>
                        ...
                        <div class="modal fade" id="modalModificar{{$item->id}}" tabindex="-1" aria-labelledby="exampleModalLabel"
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form action="{{ route('p.update', $item->id) }}" method="POST">
                                            @csrf
                                            @method('PUT')
                                            <div class="mb-3">
                                                <div>
