    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('d.create') }}" method="post">
                    @csrf
                    <div class="mb-3">
                ...
                @foreach ($donaciones as $item)
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="{{route('d.delete',$item->id)}}" onclick="return res()" class="btn btn-danger btn-sm"> <i class="fa-solid fa-trash"></i></a>
                        </td>
                        ...
                        <div class="modal fade" id="modalModificar{{$item->id}}" tabindex="-1" aria-labelledby="exampleModalLabel"
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form action="{{route('d.update',$item->id )}}" method="post">
                                            @csrf
                                            @method('PUT')
                                            <div class="mb-3">
                                                <div>
